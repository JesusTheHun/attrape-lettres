...
extension Content {
     ...
     */
    public static let letterWords: [LetterWord] = [
        ...
        LetterWord(letter: "I", word: "Igloo", emoji: "🛖", img: .igloo),
        ...
        LetterWord(letter: "J", word: "Jupe", emoji: "👗", img: .jupe),
     ...
     */
    public static let letterMatchAlphabet: [String] = [
